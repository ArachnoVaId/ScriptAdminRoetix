// NEW ADMIN UI (admin.roetix.com/events/create) - Olimpiade PPKn Unila 2026 - Essay Mahasiswa
...
var EVENT_DESCRIPTION = 'Pendaftaran Olimpiade PPKn Tahun 2026\n[OLIMPIADE PPKN UNIVERSITAS LAMPUNG TAHUN 2026]\n\n'
  ...
  + '📌Essay Mahasiswa📌 (Online)\n'
  + 'HTM: Rp50.000\n'
  + '📍More Info:\n'
  + '1. Sepvania Berlian R. (+62 853-5707-7189)\n'
  + '2. Ajeng Maudy (+62 852-1070-7451)\n\n'
...
var IDENTITY = {
  eventName: 'Olimpiade PPKn Unila 2026 - Essay Mahasiswa',
  eventId: 'PPKNUNILA2026MHSESSAY',
...
var PHASE = {
  name: 'Registrasi Essay Mahasiswa',
...
var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar Olimpiade PPKn Universitas Lampung XIII 2026 - Essay Mahasiswa. '
...
(async function run() {
  console.log('%c═══ Olimpiade PPKn Unila 2026 - Essay Mahasiswa ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
