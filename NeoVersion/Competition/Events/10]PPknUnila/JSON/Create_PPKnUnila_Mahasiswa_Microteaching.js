// NEW ADMIN UI (admin.roetix.com/events/create) - Olimpiade PPKn Unila 2026 - Microteaching Mahasiswa
...
// - Field "Nama Guru Pendamping" JUGA dihapus di event ini - RAW eksplisit menulis field itu
//   "(Khusus SMP & SMA)", jadi tidak relevan untuk kategori Mahasiswa.
...
var EVENT_DESCRIPTION = 'Pendaftaran Olimpiade PPKn Tahun 2026\n[OLIMPIADE PPKN UNIVERSITAS LAMPUNG TAHUN 2026]\n\n'
  ...
  + 'Lomba Tingkat Mahasiswa Nasional\n\n'
  + '📌Lomba Microteaching📌 (Online)\n'
  + 'HTM: Rp50.000\n'
  + '📍More Info:\n'
  + '1. Annisa Nola Andriana (+62 882-8640-3680)\n'
  + '2. Wiwin Lestari (+62 895-6097-01346)\n\n'
...
var IDENTITY = {
  eventName: 'Olimpiade PPKn Unila 2026 - Microteaching Mahasiswa',
  eventId: 'PPKNUNILA2026MHSMICRO',
...
var PHASE = {
  name: 'Registrasi Microteaching Mahasiswa',
...
// Fee 50:50 hasil kesepakatan chat 20/08: total fee Rp8.000, porsi peserta Rp4.000,
// porsi panitia Rp4.000 lainnya dipotong Roetix otomatis saat pencairan (tidak diisi di wizard).
var TIME_PRICE = { price: 50000, feeType: 'flat', fee: 4000, taxType: 'flat', tax: 0 };

var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar Olimpiade PPKn Universitas Lampung XIII 2026 - Microteaching Mahasiswa. '
...
(async function run() {
  console.log('%c═══ Olimpiade PPKn Unila 2026 - Microteaching Mahasiswa ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
