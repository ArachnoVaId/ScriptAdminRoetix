// NEW ADMIN UI (admin.roetix.com/events/create) - Olimpiade PPKn Unila 2026 - Debat SMA
...
//
// ⚠️⚠️⚠️ FEE BELUM FINAL - KONFIRMASI ULANG SEBELUM RUN ⚠️⚠️⚠️
// RAW_PPKnUnila.txt DAN MoU docx final (00000136-...docx) sama-sama masih tulis fee Debat = Rp23.750
// (porsi 50% = Rp11.875), TAPI closing statement WhatsApp 26/08 (_chat.txt baris 162-167) bilang Debat
// ikut digenapkan ke fee total Rp23.000 (porsi 11.500/11.500) sama seperti LCT - dan itu yang dipakai
// TIME_PRICE di bawah. Lihat ../PPKnUnila_status.md ALERT #1. Kalau ternyata MoU yang benar, ganti
// `fee: 11500` -> `11875` SEBELUM klik "Create event".
//
...
var EVENT_DESCRIPTION = 'Pendaftaran Olimpiade PPKn Tahun 2026\n[OLIMPIADE PPKN UNIVERSITAS LAMPUNG TAHUN 2026]\n\n'
  ...
  + 'HTM: Rp250.000\n'
  + '📍More Info:\n'
  + '1. Dhea Melinda (+62 856-0915-7219)\n'
  + '2. Maya Indriyani (+62 858-3882-1439)\n\n'
...
var IDENTITY = {
  eventName: 'Olimpiade PPKn Unila 2026 - Debat SMA',
  eventId: 'PPKNUNILA2026SMADEBAT',
...
// ⚠️ BELUM FINAL - lihat warning besar di atas & ../PPKnUnila_status.md ALERT #1.
// Fee dipakai di sini = hasil chat 26/08 (total Rp23.000, porsi 11.500/11.500), BUKAN angka MoU (Rp23.750 / 11.875).
var TIME_PRICE = { price: 250000, feeType: 'flat', fee: 11500, taxType: 'flat', tax: 0 };

var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar Olimpiade PPKn Universitas Lampung XIII 2026 - Debat SMA. '
...
(async function run() {
  console.log('%c═══ Olimpiade PPKn Unila 2026 - Debat SMA ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
  console.warn('%c⚠️ Fee Debat BELUM FINAL - cek ../PPKnUnila_status.md ALERT #1 sebelum klik Create event!', 'color:#ef4444;font-weight:bold');
