// NEW ADMIN UI (admin.roetix.com/events/create) - Olimpiade PPKn Unila 2026 - Essay SMA
...
var EVENT_DESCRIPTION = 'Pendaftaran Olimpiade PPKn Tahun 2026\n[OLIMPIADE PPKN UNIVERSITAS LAMPUNG TAHUN 2026]\n\n'
  ...
  + 'HTM: Rp50.000\n'
  + '📍More Info:\n'
  + '1. Amaliyah Husna (+62 851-8052-8451)\n'
  + '2. Rahma Aulia Octafiani (+62 819-9385-5693)\n\n'
...
var IDENTITY = {
  eventName: 'Olimpiade PPKn Unila 2026 - Essay SMA',
  eventId: 'PPKNUNILA2026SMAESSAY',
...
var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar Olimpiade PPKn Universitas Lampung XIII 2026 - Essay SMA. '
...
(async function run() {
  console.log('%c═══ Olimpiade PPKn Unila 2026 - Essay SMA ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
