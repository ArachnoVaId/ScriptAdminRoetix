// NEW ADMIN UI (admin.roetix.com/events/create) - Olimpiade PPKn Unila 2026 - Portofolio SMA
...
// - Harga Portofolio Rp50.000 adalah hasil KOREKSI chat 20/08 (rekap awal 12/08 sempat tertulis Rp25.000)
//   - lihat ../PPKnUnila_status.md, sudah konsisten dengan RAW & MoU final, tidak ada konflik tersisa.
...
var EVENT_DESCRIPTION = 'Pendaftaran Olimpiade PPKn Tahun 2026\n[OLIMPIADE PPKN UNIVERSITAS LAMPUNG TAHUN 2026]\n\n'
  ...
  + '📌Lomba Portofolio📌 (Offline)\n'
  + 'HTM: Rp50.000\n'
  + '📍More Info:\n'
  + '1. Annisa Khairina (+62 821-8518-6086)\n'
  + '2. Ria Febi Valentina (+62 857-8994-5513)\n\n'
...
var IDENTITY = {
  eventName: 'Olimpiade PPKn Unila 2026 - Portofolio SMA',
  eventId: 'PPKNUNILA2026SMAPORTO',
...
var PHASE = {
  name: 'Registrasi Portofolio SMA',
...
var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar Olimpiade PPKn Universitas Lampung XIII 2026 - Portofolio SMA. '
...
(async function run() {
  console.log('%c═══ Olimpiade PPKn Unila 2026 - Portofolio SMA ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
