// NEW ADMIN UI (admin.roetix.com/events/create) - Olimpiade PPKn Unila 2026 - Poster Digital SMA
...
var EVENT_DESCRIPTION = 'Pendaftaran Olimpiade PPKn Tahun 2026\n[OLIMPIADE PPKN UNIVERSITAS LAMPUNG TAHUN 2026]\n\n'
  ...
  + '📌Lomba Poster Digital📌 (Online)\n'
  + 'HTM: Rp20.000\n'
  + '📍More Info:\n'
  + '1. Niken Okta Azhari (+62 895-6059-99554)\n'
  + '2. Puan Maharani (+62 895-3324-34792)\n\n'
...
var IDENTITY = {
  eventName: 'Olimpiade PPKn Unila 2026 - Poster Digital SMA',
  eventId: 'PPKNUNILA2026SMAPOSTER',
...
var PHASE = {
  name: 'Registrasi Poster Digital SMA',
...
// Fee 50:50 hasil kesepakatan chat 20/08: total fee Rp5.000, porsi peserta Rp2.500,
// porsi panitia Rp2.500 lainnya dipotong Roetix otomatis saat pencairan (tidak diisi di wizard).
var TIME_PRICE = { price: 20000, feeType: 'flat', fee: 2500, taxType: 'flat', tax: 0 };

var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar Olimpiade PPKn Universitas Lampung XIII 2026 - Poster Digital SMA. '
...
(async function run() {
  console.log('%c═══ Olimpiade PPKn Unila 2026 - Poster Digital SMA ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
