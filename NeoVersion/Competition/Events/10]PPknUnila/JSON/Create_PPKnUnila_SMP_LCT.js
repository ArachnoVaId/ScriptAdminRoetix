// NEW ADMIN UI (admin.roetix.com/events/create) - Olimpiade PPKn Unila 2026 - LCT SMP
...
var EVENT_DESCRIPTION = 'Pendaftaran Olimpiade PPKn Tahun 2026\n[OLIMPIADE PPKN UNIVERSITAS LAMPUNG TAHUN 2026]\n\n'
  ...
  + 'HTM: Rp250.000\n'
  + '📍More Info:\n'
  + '1. Putri Alya Junivia (+62 856-0909-0337)\n'
  + '2. Febriana Arumning Tiyas (+62 853-8250-588)\n\n'
...
var IDENTITY = {
  eventName: 'Olimpiade PPKn Unila 2026 - LCT SMP',
  eventId: 'PPKNUNILA2026SMPLCT',
...
var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar Olimpiade PPKn Universitas Lampung XIII 2026 - LCT SMP. '
...
(async function run() {
  console.log('%c═══ Olimpiade PPKn Unila 2026 - LCT SMP ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
