// NEW ADMIN UI (admin.roetix.com/events/create) - Olimpiade PPKn Unila 2026 - Pidato SMP
...
var EVENT_DESCRIPTION = 'Pendaftaran Olimpiade PPKn Tahun 2026\n[OLIMPIADE PPKN UNIVERSITAS LAMPUNG TAHUN 2026]\n\n'
  ...
  + 'HTM: Rp80.000\n'
  + '📍More Info:\n'
  + '1. Ichmida Mahida JZ (+62 857-6836-9951)\n'
  + '2. Debi Tri Hapsari (+62 853-8329-2278)\n\n'
...
var IDENTITY = {
  eventName: 'Olimpiade PPKn Unila 2026 - Pidato SMP',
  eventId: 'PPKNUNILA2026SMPPIDATO',
...
// Fee 50:50 hasil kesepakatan chat 26/08: total fee Rp10.000, porsi peserta Rp5.000,
// porsi panitia Rp5.000 lainnya dipotong Roetix otomatis saat pencairan (tidak diisi di wizard).
var TIME_PRICE = { price: 80000, feeType: 'flat', fee: 5000, taxType: 'flat', tax: 0 };

var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar Olimpiade PPKn Universitas Lampung XIII 2026 - Pidato SMP. '
...
(async function run() {
  console.log('%c═══ Olimpiade PPKn Unila 2026 - Pidato SMP ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
