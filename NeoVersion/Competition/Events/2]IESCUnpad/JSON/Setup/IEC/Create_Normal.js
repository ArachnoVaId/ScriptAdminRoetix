// IESCUnpad IEC - Normal Phase & Add 10 Fields (Rp 149.000)
...
var FIELDS = [
  ...
  { key: 'HighSchoolName_normal', label: 'High School Name', type: 'text', required: true },
  { key: 'TeamName_normal', label: 'Team Name', type: 'text', required: true },
  { key: 'LeaderFullName_normal', label: 'Team Leader', type: 'text', required: true },
  { key: 'LeaderPhoneNumber_normal', label: 'Team Leader’s Phone Number', type: 'phone', required: true,
    notes: 'Example: +62 812-3456-7899' },
  { key: 'Member1FullName_normal', label: 'Member 1', type: 'text', required: true },
  { key: 'Member2FullName_normal', label: 'Member 2', type: 'text', required: true },
  { key: 'StudentID_normal', label: 'Student ID', type: 'file', required: true,
    notes: 'Student IDs for all team members' },
  { key: 'PosterSharingProof_normal', label: 'Proof of Poster Sharing for IEC 2025 on Instagram', type: 'file', required: true,
  ...
  { key: 'FollowProof_normal', label: 'Proof of Following Instagram Accounts for IESC', type: 'file', required: true,
...
(function run() {
  ...
  fill(byName('timelines.' + PHASE_INDEX + '.startDate'), '2026-09-14T00:00');
  fill(byName('timelines.' + PHASE_INDEX + '.endDate'), '2026-10-01T23:59');
  fill(byName('timelines.' + PHASE_INDEX + '.price'), '149000');
