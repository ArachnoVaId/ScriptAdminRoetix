// IESCUnpad ISCAAS (International) - Paper Phase & Add 9 Fields (Rp 299.000)
...
var FIELDS = [
  ...
  { key: 'PaymentProof_paper', label: 'Payment Proof', type: 'file', required: true }
];
...
(function run() {
  ...
  fill(byName('timelines.' + PHASE_INDEX + '.price'), '299000');
