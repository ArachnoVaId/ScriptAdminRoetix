...
(function run() {
  console.log('%c═══ MATRIX UI - Collective Essay Early Bird Phase + ' + FIELDS.length + ' Fields ═══', 'color:#6366f1;font-weight:bold');
  console.log('Phase index: ' + PHASE_INDEX);

  fill(byName('timelines.' + PHASE_INDEX + '.name'), 'Collective Essay Early Bird');
  console.log('Phase Name -> Collective Essay Early Bird');
