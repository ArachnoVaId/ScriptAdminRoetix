// IMOTION Mini Marketing Case - Extend Phase & Add 24 Fields
...
// "How did you find out" dipindah ke section terpisah (5) per revisi.
...
var SECTION_MAP = [
  ...
  4,                          // Section 4: Attachments (AdminProof) (1)
  5,                          // Section 5: Additional Info (InfoIMOTIONFrom) (1) — dipisah per revisi
  6,6,6                       // Section 6: Jabodetabek (1) + Support Package Proof (1, merged) + Payment (1) = 3
];
...
(function run() {
  ...
  fill(byName('timelines.' + PHASE_INDEX + '.name'), 'Mini Marketing Case Competition Extend Registration');
  console.log('Phase Name -> Mini Marketing Case Competition Extend Registration');
