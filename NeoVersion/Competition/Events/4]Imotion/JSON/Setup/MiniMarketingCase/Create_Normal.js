// IMOTION Mini Marketing Case - Normal Phase & Add 24 Fields
...
(function run() {
  ...
  fill(byName('timelines.' + PHASE_INDEX + '.name'), 'Mini Marketing Case Competition Normal Registration');
  console.log('Phase Name -> Mini Marketing Case Competition Normal Registration');
