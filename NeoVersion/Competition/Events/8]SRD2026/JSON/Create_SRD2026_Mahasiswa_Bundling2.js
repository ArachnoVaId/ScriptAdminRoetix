// NEW ADMIN UI (admin.roetix.com/events/create) - SRD 2026 Talkshow - Mahasiswa IPB (Paket Bundling Beli 2)
// Companion doc: ../../NewAdminUI/README.md (DOM notes) - format sama persis dengan Create_ICGS_DoubleTeam.js
// Data source: ../RAW_SRD2026.txt line 104-122 (DATA FORM ... pendaftar Mahasiswa IPB Bundling (Beli 2))
//
...
// report "duplicate field keys". Do not remove the suffix.
//
...
var EVENT_DESCRIPTION = 'Scholarship For Reach A Dream 2026\n"Design a Dream, Display Potential"\n\n'
  ...
  + '🎟️Paket ini: Mahasiswa IPB - Paket Bundling Beli 2 (2 peserta) - Rp30.000\n\n'
  + '🔮Jangan lewatkan kesempatan emas kalian untuk memantapkan persiapan meraih impian🪄';

var IDENTITY = {
  eventName: 'Talkshow SRD 2026 - Mahasiswa IPB (Paket Bundling 2)',
  eventId: 'SRD2026MHSBUNDLE2',
...
var TIME_PRICE = { price: 30000, feeType: 'flat', fee: 3500, taxType: 'flat', tax: 0 };
...
(async function run() {
  console.log('%c═══ SRD 2026 - Mahasiswa IPB (Paket Bundling 2) ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
