// NEW ADMIN UI (admin.roetix.com/events/create) - SRD 2026 Talkshow - Umum (Paket Bundling Beli 2)
// Companion doc: ../../NewAdminUI/README.md (DOM notes) - format sama persis dengan Create_ICGS_DoubleTeam.js
// Data source: ../RAW_SRD2026.txt line 44-61 (DATA FORM ... pendaftar Umum Paket Bundling (Beli 2))
//
...
//
// IMPORTANT: Peserta 2 fields live in the SAME Phase as Peserta 1, so their labels are suffixed
// "(Peserta 2)" below - identical labels would auto-slug to identical keys and Step 6 Review would
// report "duplicate field keys". Do not remove the suffix (same pattern as Create_ICGS_DoubleTeam.js).
//
...
var EVENT_DESCRIPTION = 'Scholarship For Reach A Dream 2026\n"Design a Dream, Display Potential"\n\n'
  ...
  + '🎟️Paket ini: Umum - Paket Bundling Beli 2 (2 peserta) - Rp40.000\n\n'
  + '🔮Jangan lewatkan kesempatan emas kalian untuk memantapkan persiapan meraih impian🪄';

var IDENTITY = {
  eventName: 'Talkshow SRD 2026 - Umum (Paket Bundling 2)',
  eventId: 'SRD2026UMUMBUNDLE2',
...
var TIME_PRICE = { price: 40000, feeType: 'flat', fee: 3500, taxType: 'flat', tax: 0 };
...
async function fillIdentity(cfg) {
  ...
  // checkboxes[0] = "use one message for both emails" (leave default ON)
...
async function reportReview() {
  ...
  console.log(ready
    ...
    : '%cNOT READY -> likely duplicate field keys (check the Peserta 2 suffixes) or missing data.', 'color:' + (ready ? '#22c55e' : '#ef4444') + ';font-weight:bold;font-size:13px');
}

// ===================== RUN =====================

(async function run() {
  console.log('%c═══ SRD 2026 - Umum (Paket Bundling 2) ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
