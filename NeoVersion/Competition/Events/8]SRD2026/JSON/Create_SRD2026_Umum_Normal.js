// NEW ADMIN UI (admin.roetix.com/events/create) - SRD 2026 Talkshow - Umum (Normal)
// Companion doc: ../../NewAdminUI/README.md (DOM notes) - format sama persis dengan Create_ICGS_SingleTeam.js
// Data source: ../RAW_SRD2026.txt line 31-42 (DATA FORM ... pendaftar Umum Normal)
//
...
var EVENT_DESCRIPTION = 'Scholarship For Reach A Dream 2026\n"Design a Dream, Display Potential"\n\n'
  ...
  + '🎟️Paket ini: Umum - Normal (1 peserta) - Rp25.000\n\n'
  + '🔮Jangan lewatkan kesempatan emas kalian untuk memantapkan persiapan meraih impian🪄';

var IDENTITY = {
  eventName: 'Talkshow SRD 2026 - Umum (Normal)',
  eventId: 'SRD2026UMUMNORMAL',
...
var TIME_PRICE = { price: 25000, feeType: 'flat', fee: 3500, taxType: 'flat', tax: 0 };
...
var SECTIONS = [
  {
    ...
    fields: [
      ...
      { label: 'Asal Instansi', type: 'text', required: true },
      { label: 'Asal Daerah', type: 'text', required: true }
    ]
  }
];
...
(async function run() {
  console.log('%c═══ SRD 2026 - Umum (Normal) ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
