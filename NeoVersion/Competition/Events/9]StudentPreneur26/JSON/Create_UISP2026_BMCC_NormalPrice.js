...
// - BMCC Registration - subevent NORMAL PRICE (2 dari 3: Early Bird / Normal Price / Late Bird)
...
// Create_UISP2026_BMCC_LateBird.js. Isi identik, beda IDENTITY/PHASE1/TIME_PRICE_CELLS saja (lihat
// komentar "BEDA ANTAR SUBEVENT" di bawah).
//
// ⚠️ EVENT INI BELUM ADA - event ID 'UISP2026BMCCNP' di bawah adalah USULAN, BELUM di-cek ke admin apakah
...
//   Create_UISP2026_BMCC.js (Early Bird) sudah pernah dijalankan lebih dulu dan pola 2-Phase-nya terbukti
//   jalan/tidak jalan di sana, cek dulu catatannya sebelum jalankan file ini.
//
// STRUKTUR:
...
var IDENTITY = {
  eventName: 'The 16th UI Studentpreneurs - Normal Price BMCC Registration',
  eventId: 'UISP2026BMCCNP', // USULAN - event BARU, cek belum dipakai (immutable setelah dibuat)
  organizerName: 'BEM FEB UI',
  description: EVENT_DESCRIPTION
};

// Phase 1 - jendela gelombang Normal Price sesuai tabel (30 September - 17 Oktober 2026), GRATIS.
var PHASE1 = { name: 'Registrasi Preliminary Normal Price', start: '2026-09-30T00:00', end: '2026-10-17T23:59' };
...
async function addSectionsAndFields(sections, expectedBaseline) {
  ...
  if (existingSectionTitles.length !== expectedBaseline) {
    console.error('%cSTOP: ada ' + existingSectionTitles.length + ' section title input di DOM sekarang, diharapkan tepat ' + expectedBaseline + '. Kemungkinan (a) draft lama belum di-reset -> jalankan Reset_UISP2026_BMCC_NormalPrice.js dulu, ATAU (b) section Phase lain masih ke-mount bareng Phase yang sedang dikerjakan (kalau begitu fungsi generic ini TIDAK AMAN dipakai apa adanya - perlu scoping manual per-Phase, belum didukung script ini). PERIKSA LAYAR sebelum lanjut apa pun.', 'color:#ef4444;font-weight:bold;font-size:13px');
