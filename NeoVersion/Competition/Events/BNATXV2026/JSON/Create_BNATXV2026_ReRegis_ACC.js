// NEW ADMIN UI (admin.roetix.com/events/create) - BNAT XV 2026 - Registrasi Ulang ACC
...
//   baris timeline: "ACC Re-Registration (Top 15) | Rp150.000 + Rp10.000 | 1 Oktober - 3 Oktober"
//
// CARA PAKAI
...
//     TIME_PRICE.price = 150.000  (harga dasar, diterima panitia)
//     TIME_PRICE.fee   = 10.000   (fee Roetix, ditambahkan)
//     Peserta membayar = 160.000
//   Verifikasi di layar Step 4 Time-Price bahwa totalnya memang Rp160.000.
//
...
//      (ketua + 2 anggota), dan DOM min/max saat toggle itu ON belum diverifikasi (README).
...
var EVENT_DESCRIPTION = [
  "RE-REGISTRATION BNAT XV 2026 - Accounting Case Competition (ACC)",
  "",
  ...
  "",
  "Biaya Registrasi Ulang ACC: Rp150.000 (+ fee Rp10.000)",
...
var IDENTITY = {
  eventName: "BNAT XV 2026 - Registrasi Ulang ACC",
  eventId: "BNATXV2026REGULANGACC",
  organizerName: 'HIMA BINUS',   // dari RAW (@himabinus / "HIMA BINUS mempersembahkan")
  description: EVENT_DESCRIPTION
};

// Dari tabel TIMELINE di akhir RAW: "ACC Re-Registration (Top 15) | Rp150.000 + Rp10.000 | 1 Oktober - 3 Oktober".
...
var HARGA_DASAR = 150000;
var FEE_ROETIX  = 10000;
var TIME_PRICE = {
...
var SECTIONS = [
  {
    ...
    "fields": [
      ...
      },
      {
        ...
        "description": "TODO PANITIA: ganti ke-15 opsi ini dengan nama tim ACC yang benar-benar lolos Top 15."
      }
    ]
  },
  {
    ...
    "fields": [
      ...
      {
        "label": "Email BINUS (Ketua Tim)",
        "type": "text",
        "required": true,
        "description": "Hanya berlaku bagi BINUSIAN. Bagi Non-BINUSIAN, isi dengan tanda \"-\". Contoh: mussadiq.fahmi@binus.ac.id"
      },
      {
        "label": "Email Pribadi (Ketua Tim)",
        "type": "text",
        "required": true,
        "description": "Hanya berlaku bagi Non-BINUSIAN. Bagi BINUSIAN, isi dengan tanda \"-\". Contoh: mussadiq.fahmi@gmail.com"
      },
      {
  ...
  },
  {
    ...
    "fields": [
      ...
      {
        "label": "NIM (Anggota Tim 1)",
        "type": "text",
        "required": true,
        "description": "Nomor Induk Mahasiswa"
      },
      {
        "label": "Email BINUS (Anggota Tim 1)",
        "type": "text",
        "required": true,
        "description": "Hanya berlaku bagi BINUSIAN. Bagi Non-BINUSIAN, isi dengan tanda \"-\". Contoh: mussadiq.fahmi@binus.ac.id"
      },
  ...
  },
  {
    ...
    "fields": [
      ...
      {
        "label": "NIM (Anggota Tim 2)",
        "type": "text",
        "required": true,
        "description": "Nomor Induk Mahasiswa"
      },
      {
        "label": "Email BINUS (Anggota Tim 2)",
        "type": "text",
        "required": true,
        "description": "Hanya berlaku bagi BINUSIAN. Bagi Non-BINUSIAN, isi dengan tanda \"-\". Contoh: mussadiq.fahmi@binus.ac.id"
      },
