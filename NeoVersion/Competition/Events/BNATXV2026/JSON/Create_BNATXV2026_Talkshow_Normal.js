// NEW ADMIN UI (admin.roetix.com/events/create) - BNAT XV 2026 Talkshow - Beyond Numbers - Normal
...
//
// HARGA: price 15000, serviceFee flat 3500, tax 0.
//   Peserta membayar Rp18500. Cocokkan angka ini di layar Step 4 > Time-Price.
//
...
var IDENTITY = {
  eventName: "BNAT XV 2026 Talkshow - Beyond Numbers - Normal",
  eventId: "BNATXV2026TALKSHOW",
...
var BRANCH_MAP = [
  ...
  },
  {
    ...
    "option": "BINUSIAN",
    "next": "Data Diri Peserta Umum - BINUSIAN"
  },
  {
    "section": "Informasi Peserta Umum",
    "field": "Kategori Peserta Umum",
  ...
  },
  {
    ...
    "field": "Kategori Peserta Umum",
    "option": "Non-BINUSIAN",
    "next": "Data Diri Peserta Umum - Non-BINUSIAN"
  }
];
...
var SECTIONS = [
  ...
  {
    "title": "Data Diri Peserta Umum - BINUSIAN",
    "fields": [
      {
        "label": "Nama Lengkap (Full Name)",
        "type": "text",
  ...
  {
    "title": "Data Diri Peserta Umum - Non-BINUSIAN",
    "fields": [
      {
        "label": "Nama Lengkap (Full Name)",
        "type": "text",
