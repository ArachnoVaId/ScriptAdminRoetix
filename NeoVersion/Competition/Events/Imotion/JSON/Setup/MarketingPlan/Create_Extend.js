// IMOTION Marketing Plan Competition - Extend Phase & Add 31 Fields
...
var FIELDS = [
  ...
  { key: 'Member3Institution_extend', label: 'Member 3 Institusi (opsional)', type: 'text', required: false,
    notes: 'Contoh: Universitas Indonesia' },
  { key: 'Member3MajorBatch_extend', label: 'Member 3 Jurusan dan Angkatan (opsional)', type: 'text', required: false,
    notes: 'Contoh: Manajemen 2025' },
  ...
  { key: 'Member3LineID_extend', label: 'LINE ID Anggota Keempat (opsional)', type: 'text', required: false },
  // Attachments
