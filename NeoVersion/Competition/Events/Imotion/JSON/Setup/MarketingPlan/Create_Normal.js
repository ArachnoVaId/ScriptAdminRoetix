// IMOTION Marketing Plan Competition - Normal Phase & Add 31 Fields
...
// 4=Fourth Member (opsional), 5=Attachments+Additional Info, 6=Support Package+Payment.
...
// NOTE: Ada 2 timeline untuk fase ini (Normal & Extended) memakai FIELDS yang sama — key diberi
// suffix _normal di sini. Untuk timeline kedua, buat Create_Extended.js dengan suffix _normal_extended
// (bukan _extended saja) supaya key tidak duplikat, sesuai konvensi di 2.TabledtoJsCompetition.md.
...
var FIELDS = [
  ...
  { key: 'LeaderInstitution_normal', label: 'Leader Institusi', type: 'text', required: true,
    notes: 'Contoh: Universitas Indonesia' },
  { key: 'LeaderMajorBatch_normal', label: 'Leader Jurusan dan Angkatan', type: 'text', required: true,
    notes: 'Contoh: Manajemen 2025' },
  { key: 'LeaderEmail_normal', label: 'Email Ketua Tim (Anggota Pertama)', type: 'email', required: true },
  { key: 'LeaderPhoneNumber_normal', label: 'Nomor WhatsApp Ketua Tim (Anggota Pertama)', type: 'phone', required: true },
  { key: 'LeaderLineID_normal', label: 'LINE ID Ketua Tim (Anggota Pertama)', type: 'text', required: true },
  // Second Member (Anggota Kedua)
  { key: 'Member1FullName_normal', label: 'Nama Anggota Kedua', type: 'text', required: true },
  { key: 'Member1Institution_normal', label: 'Member 1 Institusi', type: 'text', required: true,
    notes: 'Contoh: Universitas Indonesia' },
  { key: 'Member1MajorBatch_normal', label: 'Member 1 Jurusan dan Angkatan', type: 'text', required: true,
    notes: 'Contoh: Manajemen 2025' },
  ...
  { key: 'Member1LineID_normal', label: 'LINE ID Anggota Kedua', type: 'text', required: true },
  // Third Member (Anggota Ketiga)
  { key: 'Member2FullName_normal', label: 'Nama Anggota Ketiga', type: 'text', required: true },
  { key: 'Member2Institution_normal', label: 'Member 2 Institusi', type: 'text', required: true,
    notes: 'Contoh: Universitas Indonesia' },
  { key: 'Member2MajorBatch_normal', label: 'Member 2 Jurusan dan Angkatan', type: 'text', required: true,
    notes: 'Contoh: Manajemen 2025' },
  ...
  { key: 'Member2LineID_normal', label: 'LINE ID Anggota Ketiga', type: 'text', required: true },
  ...
  { key: 'Member3Institution_normal', label: 'Member 3 Institusi (opsional)', type: 'text', required: false,
    notes: 'Contoh: Universitas Indonesia' },
  { key: 'Member3MajorBatch_normal', label: 'Member 3 Jurusan dan Angkatan (opsional)', type: 'text', required: false,
    notes: 'Contoh: Manajemen 2025' },
  ...
  { key: 'Member3LineID_normal', label: 'LINE ID Anggota Keempat (opsional)', type: 'text', required: false },
  // Attachments
  ...
  { key: 'OutsideJabodetabek_normal', label: 'Apakah kampus tim anda/kampus salah satu anggota tim anda ada yang berasal dari LUAR JABODETABEK?', type: 'multiple_choice', required: true,
  ...
  { key: 'SupportPackageTeamForm_normal', label: 'Berkas Formulir IMOTION Support Package (Tim)', type: 'file', required: false,
  ...
  { key: 'SupportPackageIndividualForm_normal', label: 'Berkas Formulir IMOTION Support Package (Individu)', type: 'file', required: false,
...
var SECTION_MAP = [
  ...
  5,5,                        // Section 5: Attachments (1) + Additional Info (1) = 2
  6,6,6,6                     // Section 6: Support Package (2, merged) + Payment (1) + Jabodetabek (1) = 4
];
