// IMOTION Mini Marketing Case - Normal Phase & Add 25 Fields
...
// NOTE: Sama seperti Marketing Plan, akan ada 2 timeline (Normal & Extended) untuk sub-kompetisi ini.
// Untuk timeline kedua, buat Create_Extended.js dengan suffix _normal_extended supaya key tidak duplikat.
...
(function run() {
  console.log('%c═══ Mini Marketing Case - Normal Phase + ' + FIELDS.length + ' Fields ═══', 'color:#6366f1;font-weight:bold');
