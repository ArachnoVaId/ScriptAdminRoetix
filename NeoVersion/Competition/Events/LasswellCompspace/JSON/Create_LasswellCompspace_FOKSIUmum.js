// NEW ADMIN UI (admin.roetix.com/events/create) - COMMSPACE 2026 - FOKSI Umum (HTM)
...
var EVENT_DESCRIPTION = 'COMMSPACE 2026 - Lasswell Competition\n'
  + 'Kategori: FOKSI Umum (HTM)\n\n'
  + 'Biaya pendaftaran: Rp25.000 (+ flat platform fee Rp5.000, dibebankan ke peserta)\n'
...
var IDENTITY = {
  eventName: 'COMMSPACE 2026 - FOKSI Umum',
  eventId: 'COMMSPACE2026FOKSIUMUM',
...
// RAW: Rp25.000 flat 5.000 (platform fee, dibebankan ke peserta)
var TIME_PRICE = { price: 25000, feeType: 'flat', fee: 5000, taxType: 'flat', tax: 0 };

var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar FOKSI Umum COMMSPACE 2026! '
  + 'Silakan bergabung ke grup WhatsApp berikut untuk info lebih lanjut: '
  + 'https://chat.whatsapp.com/HugxckI1hQxINOADbwDE0u?s=cl&p=a&ilr=4';
...
async function addSectionsAndFields(sections) {
  ...
  for (var si = 0; si < sections.length; si++) {
    ...
    for (var fi = 0; fi < section.fields.length; fi++) {
      ...
      // checkboxes DIQUERY DI SINI (setelah type & options selesai) - "Required" selalu checkbox
      // TERAKHIR di field manapun (lihat README - multiple_choice nambah toggle "Other" sebelum Required).
...
(async function run() {
  console.log('%c═══ COMMSPACE 2026 - FOKSI Umum ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
