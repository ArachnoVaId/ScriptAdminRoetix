// NEW ADMIN UI (admin.roetix.com/events/create) - COMMSPACE 2026 - News Anchor (HTM)
...
var EVENT_DESCRIPTION = 'COMMSPACE 2026 - Lasswell Competition\n'
  + 'Kategori: News Anchor (HTM)\n\n'
  + 'Biaya pendaftaran: Rp40.000 (+ flat platform fee Rp5.000, dibebankan ke peserta)\n'
...
var IDENTITY = {
  eventName: 'COMMSPACE 2026 - News Anchor',
  eventId: 'COMMSPACE2026NEWSANCHOR',
...
// RAW: Rp40.000 flat 5.000 (platform fee, dibebankan ke peserta)
var TIME_PRICE = { price: 40000, feeType: 'flat', fee: 5000, taxType: 'flat', tax: 0 };

var COMPLETION_MESSAGE = 'Terima kasih telah mendaftar News Anchor COMMSPACE 2026! '
  + 'Silakan bergabung ke grup WhatsApp berikut untuk info lebih lanjut: '
  + 'https://chat.whatsapp.com/IS2mRtO6bkPD150oGg1xy5?s=cl&p=a&ilr=4';
...
(async function run() {
  console.log('%c═══ COMMSPACE 2026 - News Anchor ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
