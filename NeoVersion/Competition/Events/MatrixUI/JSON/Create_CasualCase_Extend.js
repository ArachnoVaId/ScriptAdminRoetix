// MATRIX UI - Casual Case Study Extend Phase & Add 9 Fields
...
var FIELDS = [
  ...
  // Team Leader
  { key: 'LeaderData_extended', label: 'Team Leader name and Whatsapp Contact', type: 'text_area', required: true,
    notes: 'Format: name/contact' },
  // Members
  { key: 'MembersData_extended', label: 'Members name and Whatsapp Contact', type: 'text_area', required: true,
    notes: 'Format:\n1. name/contact\n2. name/contact' },
  // Attachments
  { key: 'StudentCard_extended', label: 'Bukti Kartu Tanda Mahasiswa (KTM) setiap peserta', type: 'file', required: true },
...
(function run() {
  ...
  fill(byName('timelines.' + PHASE_INDEX + '.endDate'), '2026-09-15');
  console.log('End Date -> 2026-09-15');
