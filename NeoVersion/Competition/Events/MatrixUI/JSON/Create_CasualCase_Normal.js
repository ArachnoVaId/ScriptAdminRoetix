...
(function run() {
  console.log('%c═══ MATRIX UI - Casual Case Study Normal Phase + ' + FIELDS.length + ' Fields ═══', 'color:#6366f1;font-weight:bold');
  console.log('Phase index: ' + PHASE_INDEX);

  fill(byName('timelines.' + PHASE_INDEX + '.name'), 'Casual Case Study Normal');
  console.log('Phase Name -> Casual Case Study Normal');
