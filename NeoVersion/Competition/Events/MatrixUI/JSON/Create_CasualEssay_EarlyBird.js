// MATRIX UI - Casual Essay Early Bird Phase & Add 15 Fields
...
var FIELDS = [
  ...
  // Team Leader
  { key: 'LeaderName_earlybird', label: 'Leader Name', type: 'text_area', required: true,
...
(function run() {
  console.log('%c═══ MATRIX UI - Casual Essay Early Bird Phase + ' + FIELDS.length + ' Fields ═══', 'color:#6366f1;font-weight:bold');
  console.log('Phase index: ' + PHASE_INDEX);

  fill(byName('timelines.' + PHASE_INDEX + '.name'), 'Casual Essay Early Bird');
  console.log('Phase Name -> Casual Essay Early Bird');
