// MATRIX UI - Casual Essay Extend Phase & Add 15 Fields
...
(function run() {
  console.log('%c═══ MATRIX UI - Casual Essay Extend Phase + ' + FIELDS.length + ' Fields ═══', 'color:#6366f1;font-weight:bold');
  console.log('Phase index: ' + PHASE_INDEX);

  fill(byName('timelines.' + PHASE_INDEX + '.name'), 'Casual Essay Extend');
  console.log('Phase Name -> Casual Essay Extend');
