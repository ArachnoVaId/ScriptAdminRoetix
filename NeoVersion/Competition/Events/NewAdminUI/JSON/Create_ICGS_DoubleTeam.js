// NEW ADMIN UI (admin.roetix.com/events/create) - ICGS 2026 Double Team
...
//
// IMPORTANT: Tim 1 and Tim 2 fields live in the SAME Phase (not separate Phase/Event like RAINING's
// Online/Full packages), so their Labels are suffixed "(Tim 2)" below - identical labels would auto-slug
// to identical keys and Step 6 Review would report "duplicate field keys". Do not remove the suffix.
...
var IDENTITY = {
  eventName: 'ICGS 2026 - Double Team',
  eventId: 'ICGS2026DOUBLE',
...
var TIME_PRICE = { price: 200000, feeType: 'flat', fee: 0, taxType: 'flat', tax: 0 };
...
function teamFields(suffix) {
  var s = suffix ? ' (' + suffix + ')' : '';
  return [
    { label: 'Asal Sekolah' + s, type: 'text', required: true },
    { label: 'Nama Lengkap Peserta 1' + s, type: 'text', required: true },
    { label: 'Nomor Whatsapp Peserta 1' + s, type: 'phone', required: true },
    { label: 'Nama Lengkap Peserta 2' + s, type: 'text', required: true },
    { label: 'Nomor Whatsapp Peserta 2' + s, type: 'phone', required: true },
    { label: 'Nama Lengkap Peserta 3' + s, type: 'text', required: true },
    { label: 'Nomor Whatsapp Peserta 3' + s, type: 'phone', required: true },
    { label: 'Nama Lengkap Guru Pendamping' + s, type: 'text', required: true },
    { label: 'Nomor Whatsapp Guru Pendamping' + s, type: 'phone', required: true },
    { label: 'Alergi Makanan Peserta 1' + s, type: 'text', description: ALLERGY_NOTE, required: true },
    { label: 'Alergi Makanan Peserta 2' + s, type: 'text', description: ALLERGY_NOTE, required: true },
    { label: 'Alergi Makanan Peserta 3' + s, type: 'text', description: ALLERGY_NOTE, required: true },
    { label: 'Alergi Makanan Guru Pendamping' + s, type: 'text', description: ALLERGY_NOTE, required: true }
  ];
}

var SECTIONS = [
  { title: 'Data Tim & Alergi — Tim 1', fields: teamFields(null) },
  { title: 'Data Tim & Alergi — Tim 2', fields: teamFields('Tim 2') },
  {
...
async function reportReview() {
  ...
  console.log(ready
    ...
    : '%cNOT READY -> likely duplicate field keys (check the Tim 2 suffixes) or missing data.', 'color:' + (ready ? '#22c55e' : '#ef4444') + ';font-weight:bold;font-size:13px');
}

// ===================== RUN =====================

(async function run() {
  console.log('%c═══ ICGS 2026 - Double Team ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
