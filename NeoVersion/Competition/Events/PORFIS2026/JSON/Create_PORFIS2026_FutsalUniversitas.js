// NEW ADMIN UI (admin.roetix.com/events/create) - PORFIS 2026 - Futsal Universitas
...
// Data source: ../RAW_Context.txt  (blok "🏆 REGISTRATION FUTSAL UNIVERSITAS - PORFIS 2026")
//
// CARA PAKAI
...
//   "Futsal Univ - Harga Dasar Rp500.000, Fee schema Rp20.000"
...
//   Peserta membayar Rp520.000 (Rp500.000 + Rp20.000), panitia menerima Rp500.000.
//
// !!! WAJIB DIPUTUSKAN SEBELUM RUN !!!
//   a. REQUIRED: di Google Form asli, "Nama Perwakilan", "Asal Universitas", dan "Nomor WhatsApp
...
//      final Rp520.000, bukan breakdown. Rincian harga dasar + fee sudah ditulis manual di
...
//      Catatan "Format doc: Esa Unggul Jakarta" di sumber menempel pada field Bukti Pembayaran itu, jadi ikut
//      hilang; sisa yang masih berguna dipindah jadi contoh isian di field "Asal Universitas".
//   3. Judul section Google Form ("🏆 REGISTRATION FUTSAL UNIVERSITAS - PORFIS 2026") tidak dipakai sebagai
...
var EVENT_DESCRIPTION = [
  '⚽ PORFIS 2026 - Kategori: Futsal Universitas',
  '💲 Biaya pendaftaran: Rp500.000 + fee layanan Rp20.000 = Rp520.000',
...
var IDENTITY = {
  eventName: 'PORFIS 2026 - Futsal Universitas',
  eventId: 'PORFIS2026FUTSALUNIV',
...
// Harga dasar dari RAW ("Futsal Univ: Rp. 500.000") + fee dari tabel fee schema panitia.
// Skema ON-TOP: peserta bayar Rp500.000 + Rp20.000 = Rp520.000.
var TIME_PRICE = { price: 500000, feeType: 'flat', fee: 20000, taxType: 'flat', tax: 0 };

var COMPLETION_MESSAGE = [
  'Terima kasih sudah mendaftar Futsal Universitas - PORFIS 2026! 🏆',
  '',
  'Pelaksanaan: 26-28 Oktober 2026',
  'Lokasi: Lapangan Universitas Esa Unggul Jakarta',
  '',
...
var SECTIONS = [
  {
    ...
    fields: [
      ...
      { label: 'Asal Universitas', type: 'text', required: false, description: 'Contoh: Esa Unggul Jakarta' },
