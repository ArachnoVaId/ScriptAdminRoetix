// NEW ADMIN UI (admin.roetix.com/events/create) - SRD 2026 Talkshow - Mahasiswa IPB (Paket Bundling Beli 3)
// Companion doc: ../../NewAdminUI/README.md (DOM notes) - format sama persis dengan Create_ICGS_DoubleTeam.js
// Data source: ../RAW_SRD2026.txt line 124-148 (DATA FORM ... pendaftar Mahasiswa IPB Bundling (Beli 3))
//
...
var EVENT_DESCRIPTION = 'Scholarship For Reach A Dream 2026\n"Design a Dream, Display Potential"\n\n'
  ...
  + '🎟️Paket ini: Mahasiswa IPB - Paket Bundling Beli 3 (3 peserta) - Rp50.000\n\n'
  + '🔮Jangan lewatkan kesempatan emas kalian untuk memantapkan persiapan meraih impian🪄';

var IDENTITY = {
  eventName: 'Talkshow SRD 2026 - Mahasiswa IPB (Paket Bundling 3)',
  eventId: 'SRD2026MHSBUNDLE3',
...
var TIME_PRICE = { price: 50000, feeType: 'flat', fee: 3500, taxType: 'flat', tax: 0 };
...
(async function run() {
  console.log('%c═══ SRD 2026 - Mahasiswa IPB (Paket Bundling 3) ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
