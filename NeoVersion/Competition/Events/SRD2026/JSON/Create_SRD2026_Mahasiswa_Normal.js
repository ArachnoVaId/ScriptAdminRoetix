// NEW ADMIN UI (admin.roetix.com/events/create) - SRD 2026 Talkshow - Mahasiswa IPB (Normal)
// Companion doc: ../../NewAdminUI/README.md (DOM notes) - format sama persis dengan Create_ICGS_SingleTeam.js
// Data source: ../RAW_SRD2026.txt line 91-102 (DATA FORM ... pendaftar Mahasiswa IPB Normal)
//
...
var EVENT_DESCRIPTION = 'Scholarship For Reach A Dream 2026\n"Design a Dream, Display Potential"\n\n'
  ...
  + '🎟️Paket ini: Mahasiswa IPB - Normal (1 peserta) - Rp20.000\n\n'
  + '🔮Jangan lewatkan kesempatan emas kalian untuk memantapkan persiapan meraih impian🪄';

var IDENTITY = {
  eventName: 'Talkshow SRD 2026 - Mahasiswa IPB (Normal)',
  eventId: 'SRD2026MHSNORMAL',
...
var TIME_PRICE = { price: 20000, feeType: 'flat', fee: 3500, taxType: 'flat', tax: 0 };
...
var SECTIONS = [
  {
    ...
    fields: [
      ...
      { label: 'NIM Lengkap', type: 'text', required: true },
      { label: 'Fakultas Lengkap', type: 'text', required: true }
    ]
  }
];
...
(async function run() {
  console.log('%c═══ SRD 2026 - Mahasiswa IPB (Normal) ═══', 'color:#6366f1;font-weight:bold;font-size:14px');
