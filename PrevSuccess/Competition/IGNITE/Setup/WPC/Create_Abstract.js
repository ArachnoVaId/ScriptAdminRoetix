// IGNITE WPC - Abstract Phase & Add 5 Fields
...
var FIELDS = [
  ...
  { key: 'LeaderFullName_abstract', label: 'Team leader\'s full name', type: 'text', required: true },
  { key: 'LeaderEmail_abstract', label: 'Team leader\'s email', type: 'email', required: true },
  { key: 'LeaderPhoneNumber_abstract', label: 'Team leader\'s active phone number', type: 'phone', required: true },
  { key: 'Abstract_abstract', label: 'Abstract', type: 'file', required: true }
];
...
(function run() {
  ...
  fill(byName('timelines.' + PHASE_INDEX + '.startDate'), '2026-06-08');
  fill(byName('timelines.' + PHASE_INDEX + '.endDate'), '2026-06-21');
