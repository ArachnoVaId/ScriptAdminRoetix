// Grand Concert vol 12 - Event Create Page Filler (Step 1: Event Details)
// Paste in browser console at /roetix-events/create
const SUFFIX = Math.random().toString(36).substring(2, 6);
const DATA = {
  eventName: 'Grand Concert vol 12. Samsara',
  slug: `grand-concert-vol-12-samsara-${SUFFIX}`,
  eventType: 'Seated',
  location: 'Sanata Dharma Driyarkara Auditorium Performance Hall',
  ticketSalesStart: '2026-04-13T09:00',
  eventDate: '2026-05-30T17:00',
  flatAmount: '0',
  percentage: '4.4',
  feeBearer: 'Organizer',
  organizer: 'GMCO UGM',
  description: 'In every rise of melody and fall of silence, a soul remembers its journey. Samsara - An elegy of a Soul. Where sound becomes reflection, and reflection becomes peace.',
};
...
console.log('%c═══ Grand Concert - Step 1: Event Details ═══', 'color:#6366f1;font-weight:bold');
